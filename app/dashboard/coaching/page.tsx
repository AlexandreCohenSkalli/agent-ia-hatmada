  ...
  return (
    <div style={{ padding: '2rem' }}>
      ...
      <div style={{ background: 'white', borderRadius: '0.875rem', padding: '1.5rem', boxShadow: '0 2px 8px rgba(0,0,0,0.07)', marginBottom: '1.5rem', border: '2px dashed #bbf7d0' }}>
        ...
        <p style={{ color: '#64748b', marginBottom: '0.75rem', fontSize: '0.9375rem' }}>Colonnes reconnues : <strong>Prénom, Nom, Fonction, Société, Email</strong>, URL LinkedIn, Site Internet. (Ordre quelconque)</p>
        ...
        <div
          style={{
            ...
            gap: '1rem',
            padding: '2rem 1.5rem',
            border: `2px dashed ${dragActive ? '#22c55e' : '#cbd5e1'}`,
            borderRadius: '0.5rem',
            cursor: 'pointer',
        ...
        >
          <Upload size={24} color={dragActive ? '#22c55e' : '#94a3b8'} />
          <div>
